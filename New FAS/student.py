...
class Student:
    def __init__(self,root):
        ...
        self.root.title("Student Panel | Face Recognition Attendance System")
    ...
    # This part is image labels setting start 
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text=" Enter Student Details ",font=("Helvetica",12,"bold"),fg="navyblue")
        ...
        #label Year
        year_label=Label(current_course_frame,text="Year*",font=("Helvetica",12,"bold"),bg="white",fg="navyblue")
        year_label.grid(row=1,column=0,padx=5,sticky=W)

        #combo box 
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,width=15,font=("Helvetica",12),state="readonly")
        year_combo["values"]=("Select Year","2017-21","2018-22","2019-23","2020-24","2021-25", "2022-26", "2023-27", "2024-28", "2025-29", "2026-30")
        ...
        #Student id
        studentId_label = Label(class_Student_frame,text="Student ID :",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        studentId_label.grid(row=0,column=0,padx=5,pady=5,sticky=W)

        studentId_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_id,width=15,font=("Helvetica",12),state="readonly")
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Class Shift* :",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        student_div_label.grid(row=1,column=0,padx=5,pady=5,sticky=W)

        div_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_div,width=13,font=("Helvetica",12),state="readonly")
        ...
        student_roll_entry = ttk.Entry(class_Student_frame,textvariable=self.var_roll,width=15,font=("Helvetica",12))
        student_roll_entry.grid(row=1,column=3,padx=5,pady=5,sticky=W)

        #Gender
        student_gender_label = Label(class_Student_frame,text="Gender* :",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        student_gender_label.grid(row=2,column=0,padx=5,pady=5,sticky=W)

        #combo box 
        gender_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_gender,width=13,font=("Helvetica",12),state="readonly")
        gender_combo["values"]=("Male","Female","Others")
        gender_combo.current(0)
        gender_combo.grid(row=2,column=1,padx=5,pady=5,sticky=W)

        #Date of Birth
        student_dob_label = Label(class_Student_frame,text="DOB* :",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        student_dob_label.grid(row=2,column=2,padx=5,pady=5,sticky=W)

        student_dob_entry = ttk.Entry(class_Student_frame,textvariable=self.var_dob,width=15,font=("Helvetica",12))
        student_dob_entry.grid(row=2,column=3,padx=5,pady=5,sticky=W)

        #Email
        student_email_label = Label(class_Student_frame,text="Email* :",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        student_email_label.grid(row=3,column=0,padx=5,pady=5,sticky=W)

        student_email_entry = ttk.Entry(class_Student_frame,textvariable=self.var_email,width=15,font=("Helvetica",12))
        student_email_entry.grid(row=3,column=1,padx=5,pady=5,sticky=W)

        #Phone Number
        student_mob_label = Label(class_Student_frame,text="Contact No* :",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        student_mob_label.grid(row=3,column=2,padx=5,pady=5,sticky=W)

        student_mob_entry = ttk.Entry(class_Student_frame,textvariable=self.var_mob,width=15,font=("Helvetica",12))
        student_mob_entry.grid(row=3,column=3,padx=5,pady=5,sticky=W)

        #Address
        student_address_label = Label(class_Student_frame,text="Address* :",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        student_address_label.grid(row=4,column=0,padx=5,pady=5,sticky=W)

        student_address_entry = ttk.Entry(class_Student_frame,textvariable=self.var_address,width=15,font=("Helvetica",12))
        student_address_entry.grid(row=4,column=1,padx=5,pady=5,sticky=W)

        #Teacher Name
        #student_tutor_label = Label(class_Student_frame,text="Tutor Name:",font=("Helvetica",12,"bold"),fg="navyblue",bg="white")
        #student_tutor_label.grid(row=4,column=2,padx=5,pady=5,sticky=W)

        #student_tutor_entry = ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=15,font=("Helvetica",12,"bold"))
        ...
        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("Helvetica",12,"bold"),fg="white",bg="navyblue")
        take_photo_btn.grid(row=0,column=5,padx=5,pady=10,sticky=W)

        #update photo button
        #update_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Update Pic",width=9,font=("Helvetica",12,"bold"),fg="white",bg="navyblue")
        #update_photo_btn.grid(row=0,column=6,padx=5,pady=10,sticky=W)
        ...
        #----------------------------------------------------------------------
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text=" Show Student Details ",font=("Helvetica",12,"bold"),fg="navyblue")
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("ID","Name","Course","Year","Sem","Div","Gender","DOB","Contact No","Address","Roll No","Email","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" :
            ...
            if(re.fullmatch(regex, self.var_email.get())):
                try:
                    ...
                    if Update > 0:
                        conn = mysql.connector.connect(username='root', password='',host='localhost',database='face_recognition',port=3306)
                        mycursor = conn.cursor()
                        mycursor.execute("update student set Name=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,PhotoSample=%s where Student_ID=%s",( 
                        self.var_std_name.get(),
                        #self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Course,Year,Semester,Division,Gender,DOB,Mobile_No,Address,Roll_No,Email,PhotoSample FROM student where Name='" +str(self.var_search.get()) + "'" 
...
# ==================================Generate Data set take image=========================
    def generate_dataset(self):
        if self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_radio1.get()=="" :
            ...
            if self.var_radio1.get()=="Yes":
                try:
                    ...
                    mycursor.execute("update student set Name=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Student_ID=%s,Email=%s,PhotoSample=%s where Roll_No=%s",( 
                        self.var_std_name.get(),
                        #self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
                    ...
                    face_classifier = cv2.CascadeClassifier("New FAS/haarcascade_frontalface_default.xml")
                    ...
                    while True:
                        ...
                        if face_croped(my_frame) is not None:
                            ...
                            file_path="New FAS/data_img/student."+str(id)+"."+str(img_id)+".jpg"
                ...
                messagebox.showerror("Error","You selected No Photo Sample!",parent=self.root)
